...
class PhongChat extends StatefulWidget {
  final String? roomId;
  final String? tieuDe;
  ...
  @override
  State<PhongChat> createState() => _PhongChatState();
}

class _PhongChatState extends State<PhongChat> {
  ...
  String get tieuDePhong {
    if (widget.tieuDe != null && widget.tieuDe!.trim().isNotEmpty) {
      return widget.tieuDe!.trim();
    }
    ...
    try {
      ...
      if (!doc.exists) {
        await roomRef.set({
          ...
          'userId': maKhachHang,
          'createdBy': maKhachHang,
          'customerEmail': emailKhachHang,
